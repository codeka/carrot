...
public interface BinaryOperator {
   ...
   * <p>
   * Note that the right operand is passed as a {@link Lazy} because some operands may not need to evaluate it, depending on the left operand (e.g. boolean `and` and `or` operators).
   *
